...
function Bio() {
  return (
    <div className="bg-gradient-to-b from-light to-skyBlue">
      <div id="bio" className="text-center mt-16 mx-2 lg:mx-48 pb-8">
        ...
        <p className="mx-2 md:px-2">
          ...
          based out of the United States, in Shreveport, Louisiana specifically.
          Some of my favorite languages and technologies include: Javascript,
          Mongoose, GraphQL and Tailwind CSS.
        </p>
      </div>
    </div>
  );
